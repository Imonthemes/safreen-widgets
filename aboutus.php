...
class safreen_aboutus extends WP_Widget {
  ...
  <div class="medium-6  columns">
                            <div class="feature-box">
                                <i class="fa <?php echo esc_attr($instance['icon1']);?> fa-4x wow zoomIn"  ></i>
...
<div class="medium-6  columns">
                            <div class="feature-box">
                                <i class="fa <?php echo esc_attr($instance['icon2']);?> fa-4x wow zoomIn"  ></i>
                                <div class="text wow fadeIn" >
...
<div class="medium-6  columns">
                            <div class="feature-box">
                                <i class="fa <?php echo esc_attr($instance['icon3']);?> fa-4x wow zoomIn"  ></i>
                                <div class="text wow fadeIn" >
...
<div class="medium-6  columns">
                            <div class="feature-box">
                                <i class="fa <?php echo esc_attr($instance['icon4']);?> fa-4x wow zoomIn"  ></i>
                                <div class="text wow fadeIn" >
...
'title4' => __('Compliance Solutions', 'safreen-widgets'),
        ...
        <!--BLOCK 1 START-->
         <div class="safreen_accordion">        
                 	<h4> <?php _e('Block 1', 'safreen-widgets') ?></h4>
          
          <div class="safreen_dion_wrap">                  
         <p>
